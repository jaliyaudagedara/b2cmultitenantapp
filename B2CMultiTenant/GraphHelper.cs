...
namespace B2CMultiTenant
{
    public class GraphHelper
    {
        public static async Task GetUserAttr(string userId, User user)
        {
            ...
            var ctx = new AuthenticationContext("https://login.microsoftonline.com/mrochonb2cprod.onmicrosoft.com/");
            ...
            var requestUri = String.Format("https://graph.windows.net/mrochonb2cprod.onmicrosoft.com/users/{0}?api-version=1.6", userId);
        ...
        {
            //var users = http.GetStringAsync(String.Format("https://graph.windows.net/mrochonb2cprod.onmicrosoft.com/users/{0}?api-version=1.6", userObjId)).Result;
            //var users = http.GetStringAsync(String.Format("https://graph.windows.net/mrochonb2cprod.onmicrosoft.com/applications/{0}/extensionProperties?api-version=1.6", extApp)).Result;
            ...
            var http = new HttpClient();
            var requestUri = String.Format("https://graph.windows.net/mrochonb2cprod.onmicrosoft.com/users/{0}?api-version=1.6", userObjId);
            http.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", resp.AccessToken);
            var extProp = new
            {
